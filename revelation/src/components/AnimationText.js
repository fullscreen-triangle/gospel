...
export const AnimationText1 = () => {
  return (
    <Fragment>
      <TypeAnimation
        cursor={true}
        sequence={[" Charge Oscillator", 1000, " Partition Theory", 1000, " Genomic Framework", 1000]}
        wrapper="span"
        repeat={Infinity}
      />
    </Fragment>
...
const skills = ["Charge Dynamics", "Partition Computing", "Structural Derivation"];
  ...
  return (
    <Fragment>
      <span className="cd-headline rotate-1">
        <span className="blc">Nucleic Acid </span>
